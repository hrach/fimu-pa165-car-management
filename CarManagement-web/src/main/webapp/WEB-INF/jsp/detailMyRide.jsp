...
<hr>
<p><a class="btn btn-info" href="${pageContext.request.contextPath}/myride/"><span class="glyphicon glyphicon-circle-arrow-left"></span> <spring:message code="ride.backtolist" /></a></p>
        </div>          
            </div>
        </div>
    </body>
