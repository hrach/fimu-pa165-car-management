...
<html>
    <head>
        ...
        <title><spring:message code="myrides.add" /></title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h1><spring:message code="myrides" /></h1>
            </div>
            <h3><spring:message code="myrides.add" /></h3>

            <form:form cssClass="form-horizontal" method="POST" modelAttribute="newRide" action="${pageContext.request.contextPath}/myride/add">  
