...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form:form cssClass="form-horizontal" method="POST" modelAttribute="vehicleType" action="${pageContext.request.contextPath}/vehicle-type/edit/${vehicleType.id}.html">  
