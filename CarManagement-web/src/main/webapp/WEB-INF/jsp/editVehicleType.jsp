<%-- 
    ...
    Created on : 12.12.2013, 19:41:34
    Author     : tomasbobek
--%>
...
<html>
    <head>
        ...
        <title><spring:message code="vehicletype.edit" /></title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h1><spring:message code="vehicletype.edit" /></h1>
            </div>

            <form:form cssClass="form-horizontal" method="POST" modelAttribute="vehicleType" action="${pageContext.request.contextPath}/admin/vehicle-type/edit/${vehicleType.id}.html">  
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/vehicle-type/" class="btn btn-warning"><spring:message code="cancel" /></a>
                    </div>
                </div>    
            </form:form>  
        </div>
